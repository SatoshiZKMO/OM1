...
To help keep contributions consistent and easy to review, please ensure that you:

- Fork the repository and create your branch from `main`
- Keep pull requests small and focused
- Write clear and descriptive commit messages
- Ensure all checks and workflows pass
- Include a concise description in your pull request

Small improvements such as documentation updates, CI tweaks, and configuration fixes are always welcome.
